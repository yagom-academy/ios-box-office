...
//데이터 매니저와 date를 저장프로퍼티에서 제외한 코드
//final class BoxOfficeViewController: UIViewController, UICollectionViewDelegate {
//    // MARK: Properties
//    private var rankingViewType: BoxOfficeRankingViewType = .list
//
...
//           }
//           return DataManager(date: boxOfficeDate)
//       }
//
//
//    private func fetchBoxOfficeData() {
...
//                self?.processBoxOfficeFetchResult(result: result, dataManager: dataManager)
//            }
//        }
//
//    private func processBoxOfficeFetchResult(result: Result<[BoxOfficeMovieInfo], Error>, dataManager: DataManager) {
//        switch result {
//        case .success(_):
//            DispatchQueue.main.async {
//                self.stopLoadingView()
//                self.collectionView?.refreshControl?.endRefreshing()
//                self.applySnapshot(section: self.rankingViewType, dataManager: dataManager)
//            }
//        case .failure(let error):
//            presentErrorAlert(error: error, title: "\(BoxOfficeError.failedToGetData)")
//        }
...
//        return UICollectionView.CellRegistration<MovieRankingListCell, BoxOfficeMovieInfo> { cell, indexPath, item in
//            let uiModel = CellUIModel(data: item)
//            cell.updateListLabel(for: uiModel)
//        }
//    }
//
//    func applySnapshot(section: BoxOfficeRankingViewType?, dataManager: DataManager) {
