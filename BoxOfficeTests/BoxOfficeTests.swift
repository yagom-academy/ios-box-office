...
final class BoxOfficeTests: XCTestCase {
    ...
    func test_첫번째_dailyBoxOfficeList_값이_json_데이터와_일치한다() {
        // given
        let result = DailyBoxOffice(number: "1",
                                    rank: "1",
                                    rankIncrement: "0",
                                    rankOldAndNew: .new,
                                    movieCode: "20199882",
                                    movieKoreanName: "경관의 피",
                                    openDate: "2022-01-05",
                                    salesAmount: "584559330",
                                    salesShare: "34.2",
                                    salesIncrement: "584559330",
                                    salesChange: "100",
                                    salesAccumulation: "631402330",
                                    audienceCount: "64050",
                                    audienceIncrement: "64050",
                                    audienceChange: "100",
    ...
    func test_두번째_dailyBoxOfficeList_값이_json_데이터와_일치한다() {
        // given
        let result = DailyBoxOffice(number: "2",
                                    rank: "2",
                                    rankIncrement: "-1",
                                    rankOldAndNew: .old,
                                    movieCode: "20210028",
                                    movieKoreanName: "스파이더맨: 노 웨이 홈",
                                    openDate: "2021-12-15",
                                    salesAmount: "507028380",
                                    salesShare: "29.6",
                                    salesIncrement: "-91443730",
                                    salesChange: "-15.3",
                                    salesAccumulation: "62772471900",
                                    audienceCount: "50399",
                                    audienceIncrement: "-9564",
                                    audienceChange: "-15.9",
                                    audienceAccumulation: "6252827",
                                    screenCount: "1357",
                                    showCount: "4314")
        // when
        let jsonDecoder = JSONDecoder()
